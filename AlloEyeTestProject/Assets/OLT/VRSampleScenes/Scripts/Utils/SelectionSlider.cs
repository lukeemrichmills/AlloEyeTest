...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionSlider : MonoBehaviour
    {
        ...
        [SerializeField]
        private SteamVr_ControllerEvents m_controllerEvents; //Reference to SteamVR controller events (need to add one for each controller)
        [SerializeField]
        ...
        private void OnEnable()
        {
            ...
            {
                m_controllerEvents.TriggerClicked += HandleSteamVRDown;
                m_controllerEvents.TriggerUnclicked += HandleSteamVRUp;
            }
            else
            {
                Debug.LogWarning("No VR handler is assigned to the current object");
            }
        ...
        private void HandleSteamVRDown(object sender, ControllerClickedEventArgs e)
        {
            HandleDown();
        }
        ...
        private void HandleSteamVRUp(object sender, ControllerClickedEventArgs e)
        {
            HandleUp();
        }
