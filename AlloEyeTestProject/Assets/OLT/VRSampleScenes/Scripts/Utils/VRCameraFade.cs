...
namespace VRStandardAssets.Utils
{
    ...
    public class VRCameraFade : MonoBehaviour
    {
        ...
        private bool m_IsFadeOut;                                     // Set to true whenever is fading OUT
        ...
        public bool IsFadeOut { get { return m_IsFadeOut; } }
        ...
        public void SetFadeOutColor()
        {
            m_FadeImage.color = m_FadeColor;
        }

        public void SetFadeInColor()
        {
